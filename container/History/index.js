    ...
    _renderEachItem = (item) => {
        ...
        return (
            <View style={styles.flexStyle}>
                <Text style={styles.dateStyle}>{key}</Text>
                <Text style={styles.textStyle}>{'\u2022' + " "}Total Water Consumed: {item[key].today_water_consumption} gallons</Text>
                <Text style={styles.textStyle}>{'\u2022' + " "}Total Workout Done: {item[key].today_workout_minutes} minutes</Text>
                <Text style={styles.textStyle}>{'\u2022' + " "}Total sleep hours: {item[key].today_sleep_hours} hours</Text>
            </View>
        )
    }
